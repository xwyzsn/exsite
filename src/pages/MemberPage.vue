<template>
  <q-page padding class="md:tw-w-2/3 tw-m-auto ">
    ...
    <div class="tw-mt-5 tw-h-full ">
      ...
      <div v-if="teacher" class="tw-grid tw-grid-cols-1 tw-gap-6  md:tw-grid-cols-2 tw-h-full">
    ...
    <div class="tw-mt-5  ">
      ...
      <div v-if="doctor"
        class="tw-grid tw-grid-cols-1 tw-grid-rows-[300px] section sm:tw-grid-cols-2 md:tw-grid-cols-4 tw-gap-3 tw-relative">
      ...
      <div v-else class="tw-grid tw-grid-cols-4 tw-gap-5 section ">
    ...
    <div class="tw-mt-5  ">
      ...
      <div v-if="master"
        class="tw-grid tw-grid-cols-1 section   tw-m-auto sm:tw-grid-cols-2 md:tw-grid-cols-4 tw-gap-5 tw-relative">
    ...
    <div class="tw-mt-5  ">
      ...
      <div v-if="alumni" class="tw-grid section tw-grid-cols-1 tw-gap-4 md:tw-pl-10">
